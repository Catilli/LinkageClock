<?php
/**
 * User functions for LinkageClock theme
 * Handles avatars, user names, and user-related utilities
 */

/**
 * Get user's display name using first name + last name with fallback
 * 
 * @param int|object $user User ID or user object
 * @return string Formatted display name
 */
function linkage_get_user_display_name($user) {
    if (is_numeric($user)) {
        $user_id = $user;
